...
// RegisterBbx 向管控台注册 BBX 代理
func RegisterBbx(managerURL, installToken, hostname, arch string, insecureSkipVerify bool) (*RegisterResponse, error) {
  client := &http.Client{}
  if strings.HasPrefix(managerURL, "https://") && insecureSkipVerify {
  ...
  requestUrl := managerURL + "/api/v1/bbx/register"
