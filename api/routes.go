...
func (s *Server) Router() *mux.Router {
  ...
  r.HandleFunc("/api/vms/files/upload", s.handleVmFileUpload).Methods("POST")
  r.HandleFunc("/api/vms/files/download", s.handleVmFileDownload).Methods("POST")
  r.HandleFunc("/api/vms/files/list", s.handleVmFileList).Methods("POST")
  ...
  // VM Management endpoints with path parameters (must come after specific endpoints)
