...
type ResourceCache struct {
  mu          sync.RWMutex
  systemData  models.ResourceStats
  processData map[int]models.ResourceStats
...
func NewResourceCache(ttl time.Duration) *ResourceCache {
  return &ResourceCache{
    processData: make(map[int]models.ResourceStats),
...
func (rc *ResourceCache) GetSystemResources() (models.ResourceStats, bool) {
  rc.mu.RLock()
  defer rc.mu.RUnlock()
...
func (rc *ResourceCache) SetSystemResources(stats models.ResourceStats) {
  rc.mu.Lock()
  defer rc.mu.Unlock()
...
func (rc *ResourceCache) GetProcessResources(pid int) (models.ResourceStats, bool) {
  rc.mu.RLock()
  defer rc.mu.RUnlock()
...
func (rc *ResourceCache) SetProcessResources(pid int, stats models.ResourceStats) {
  rc.mu.Lock()
  defer rc.mu.Unlock()
...
func (rm *ResourceMonitor) GetCachedSystemResources() (models.ResourceStats, bool) {
  return rm.cache.GetSystemResources()
}

// GetCachedProcessResources returns the latest cached process resources
func (rm *ResourceMonitor) GetCachedProcessResources(pid int) (models.ResourceStats, bool) {
