...
func (c *CLI) setupMqttTestCommands() *cobra.Command {
	...
	// 全局MQTT测试参数
	mqttTestCmd.PersistentFlags().StringVarP(&server, "server", "s", "localhost", "MQTT server address")
	mqttTestCmd.PersistentFlags().IntVarP(&port, "port", "p", 1883, "MQTT server port")
	mqttTestCmd.PersistentFlags().StringVarP(&user, "user", "u", "", "MQTT username")
	mqttTestCmd.PersistentFlags().StringVarP(&password, "password", "P", "", "MQTT password")
	...
	allCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestAll(server, port, user, password)
		},
	}
	mqttTestCmd.AddCommand(allCmd)

	// Add MQTT 3.1.1 test commands
	mqtt311Cmd := c.setupMqtt311TestCommands(server, port, user, password)
	mqttTestCmd.AddCommand(mqtt311Cmd)

	// Add MQTT 5.0 test commands
	mqtt50Cmd := c.setupMqtt50TestCommands(server, port, user, password)
	mqttTestCmd.AddCommand(mqtt50Cmd)

	// Add EMQX specific test commands
	emqxCmd := c.setupEmqxTestCommands(server, port, user, password)
...
func (c *CLI) setupMqtt311TestCommands(server string, port int, user string, password string) *cobra.Command {
	...
	connectCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestConnect(server, port, user, password)
		},
	}
	...
	pubsubCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestPubSub(server, port, user, password)
		},
	}
	...
	qosCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestQoS(server, port, user, password)
		},
	}
	...
	retainedCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestRetained(server, port, user, password)
		},
	}
	...
	wildcardCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestWildcard(server, port, user, password)
		},
	}
	...
	keepaliveCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestKeepAlive(server, port, user, password)
		},
	}
	...
	aclCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestACL(server, port, user, password)
		},
	}
	...
	tlsCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestTLS(server, port, user, password)
		},
	}
...
func (c *CLI) setupMqtt50TestCommands(server string, port int, user string, password string) *cobra.Command {
	...
	sessionExpiryCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestSessionExpiry(server, port, user, password)
		},
	}
	...
	messageExpiryCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestMessageExpiry(server, port, user, password)
		},
	}
	...
	reasonCodeCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestReasonCode(server, port, user, password)
		},
	}
	...
	userPropertiesCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestUserProperties(server, port, user, password)
		},
	}
	...
	responseTopicCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestResponseTopic(server, port, user, password)
		},
	}
	...
	sharedSubCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestSharedSubscription(server, port, user, password)
		},
	}
	...
	subscriptionIdCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestSubscriptionIdentifier(server, port, user, password)
		},
	}
	...
	noLocalCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestNoLocal(server, port, user, password)
		},
	}
	...
	retainHandlingCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestRetainHandling(server, port, user, password)
		},
	}
	...
	maxPacketSizeCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestMaxPacketSize(server, port, user, password)
		},
	}
	...
	receiveMaxCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestReceiveMax(server, port, user, password)
		},
	}
...
func (c *CLI) setupEmqxTestCommands(server string, port int, user string, password string) *cobra.Command {
	...
	qos2PersistenceCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestQoS2Persistence(server, port, user, password)
		},
	}
	...
	offlineQueueCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return c.handleMqttTestOfflineQueue(server, port, user, password)
		},
	}
...
func (c *CLI) handleMqttTestAll(server string, port int, user string, password string) error {
	...
	tests := []struct {
		...
		// MQTT 3.1.1 Tests
		{"Connect Test", func() error { return c.handleMqttTestConnect(server, port, user, password) }},
		{"PubSub Test", func() error { return c.handleMqttTestPubSub(server, port, user, password) }},
		{"QoS Test", func() error { return c.handleMqttTestQoS(server, port, user, password) }},
		{"Retained Message Test", func() error { return c.handleMqttTestRetained(server, port, user, password) }},
		{"Wildcard Subscription Test", func() error { return c.handleMqttTestWildcard(server, port, user, password) }},
		{"Keep Alive Test", func() error { return c.handleMqttTestKeepAlive(server, port, user, password) }},
		{"ACL Test", func() error { return c.handleMqttTestACL(server, port, user, password) }},
		{"TLS Test", func() error { return c.handleMqttTestTLS(server, port, user, password) }},

		// MQTT 5.0 Tests
		{"Session Expiry Test", func() error { return c.handleMqttTestSessionExpiry(server, port, user, password) }},
		{"Message Expiry Test", func() error { return c.handleMqttTestMessageExpiry(server, port, user, password) }},
		{"Reason Code Test", func() error { return c.handleMqttTestReasonCode(server, port, user, password) }},
		{"User Properties Test", func() error { return c.handleMqttTestUserProperties(server, port, user, password) }},
		{"Response Topic Test", func() error { return c.handleMqttTestResponseTopic(server, port, user, password) }},
		{"Shared Subscription Test", func() error { return c.handleMqttTestSharedSubscription(server, port, user, password) }},
		{"Subscription Identifier Test", func() error { return c.handleMqttTestSubscriptionIdentifier(server, port, user, password) }},
		{"No Local Test", func() error { return c.handleMqttTestNoLocal(server, port, user, password) }},
		{"Retain Handling Test", func() error { return c.handleMqttTestRetainHandling(server, port, user, password) }},
		{"Maximum Packet Size Test", func() error { return c.handleMqttTestMaxPacketSize(server, port, user, password) }},
		{"Receive Maximum Test", func() error { return c.handleMqttTestReceiveMax(server, port, user, password) }},

		// EMQX Specific Tests
		{"QoS 2 Persistence Test", func() error { return c.handleMqttTestQoS2Persistence(server, port, user, password) }},
		{"Offline Queue Test", func() error { return c.handleMqttTestOfflineQueue(server, port, user, password) }},
	}
...
func (c *CLI) handleMqttTestConnect(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestPubSub(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestQoS(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestRetained(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestWildcard(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestKeepAlive(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestACL(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestTLS(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestSessionExpiry(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestMessageExpiry(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestReasonCode(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestUserProperties(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestResponseTopic(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestSharedSubscription(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestSubscriptionIdentifier(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestNoLocal(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestRetainHandling(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestMaxPacketSize(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestReceiveMax(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestQoS2Persistence(server string, port int, user string, password string) error {
...
func (c *CLI) handleMqttTestOfflineQueue(server string, port int, user string, password string) error {
